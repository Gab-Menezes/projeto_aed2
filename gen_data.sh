...
video_reolution=$(echo $video_file_without_extension | cut -f 2 -d '_')
...
compression_time_file="compression_time_${video_reolution}.dat"
compression_avg_segment_size_file="compression_avg_segment_size_${video_reolution}.dat"
compression_ratio_file="compression_ratio_${video_reolution}.dat"
